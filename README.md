...
- **Send a note to someone** with the **Share** button on the top bar. The whole
  ...
  smaller for the trip; the copies in your notes are untouched. If a mail or chat
  app shortens the link on the way, the reader still shows everything that
  arrived and says plainly that the rest was cut. Anyone with the link can read
  it, and you cannot take it back — treat it like handing over a photocopy.
